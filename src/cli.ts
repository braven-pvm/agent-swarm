...
type RunFocusPacket = ReturnType<typeof buildRunFocusPacket>;
type SliceFocusPacket = ReturnType<typeof buildSliceFocusPacket>;

function buildRunFocusPacket(
  store: SwarmStore,
  workspace: string,
  runId: string,
...
function buildSliceFocusPacket(
  store: SwarmStore,
  workspace: string,
  sliceId: string,
...
function classifyRunFocus(input: {
  run: AgentRunRecord;
...
function buildOverseerFocusQueue(input: {
  store: SwarmStore;
  workspace: string;
  snapshot: ReturnType<typeof buildObservabilitySnapshot>;
  cli: string;
...
function summarizeSliceFocusForPrompt(packet: SliceFocusPacket, cli: string) {
