...
- [Live Smoke Support Triage Product Spec](requirements/live-smoke-support-triage-product-spec.md) — approved Harness 2 product target for the next full-product smoke.
- [Live Smoke Support Triage API Requirements](requirements/live-smoke-support-triage-api-requirements.md) — Harness 2 backend source spec.
- [Live Smoke Support Triage UI Requirements](requirements/live-smoke-support-triage-ui-requirements.md) — Harness 2 frontend source spec.
- [Live Smoke Support Triage Design System](requirements/live-smoke-support-triage-design-system.md) — Harness 2 design tokens and human-visual criteria.
...
- [Live Agent Smoke Harness 2](architecture/live-agent-smoke-harness-2.md) — Customer Support Triage Board scenario plan for the second, more complex product smoke.
- [Harness-Managed Skills](architecture/harness-managed-skills.md) — built-in/project/scenario skill binding model.
- [Skill Observability UI Contract](architecture/skill-observability-ui-contract.md) — UI-facing shape for skill bindings and skill artifacts.
...
- local `swarm serve` web viewer/control server is implemented with tabs for Overview, Specs, Work, Agents, Events, History, and bounded human-action workflows
...
- latest accepted invoice control run: `LAR-20260618T141404-live-agent-smoke-none-13300`, outcome `accepted`, coverage `83/83`, product readiness passed, active escalations `0`, `11` accepted slices, `48` agent runs, and `11` verifier runs
- Harness 2 source package, reset scaffold, deterministic fake-agent E2E, and H2 live-run CLI boundary are implemented; use `swarm smoke live-agent reset --scenario live-agent-smoke-h2` for reset-only setup, `swarm smoke live-agent fake --reset --scenario live-agent-smoke-h2` for the fake lifecycle/product-readiness regression, and `swarm smoke live-agent full --reset --scenario live-agent-smoke-h2` for the bounded real-agent Customer Support Triage Board path
